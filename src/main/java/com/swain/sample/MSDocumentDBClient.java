...
import com.swain.sample.common.AccountSettings;
import com.swain.sample.common.Families;
import com.swain.sample.common.Family;
...
public class MSDocumentDBClient {
    ...
    protected static Logger logger = LoggerFactory.getLogger(MSDocumentDBClient.class.getSimpleName());
    ...
    public static void main(String[] args) {
        MSDocumentDBClient p = new MSDocumentDBClient();
